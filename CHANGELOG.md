...
<!-- GENERATED — do not hand-edit this section. Unreleased entries live as
fragments in changelog/unreleased/ (one file per lane: <issue>-<slug>.md);
a release lane folds them into a version section with
