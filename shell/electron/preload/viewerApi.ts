...
// Bridge to Aether shell's reveal sequence: tell main the renderer mounted so
// the splash dismisses promptly (otherwise revealMain falls back to its 2.5s watchdog).
